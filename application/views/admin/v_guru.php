    ...
    <div class="col-md-12">
      ...
      <div class="box box-success" style="overflow-x: scroll;">
        <div class="box-header with-border">
          ...
          <a href="<?= base_url('guru'); ?>" class="btn btn-default btn-flat"><span class="fa fa-refresh"></span> Refresh</a>
        </div>
        <!-- /.box-header -->
            ...
            <tbody>
              ...
              foreach ($guru as $m) { ?>
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      <button type="button" class="btn btn-warning btn-xs btn-flat dropdown-toggle" data-toggle="dropdown">Edit/Hapus
                        <span class="caret"></span>
                        <span class="sr-only">Toggle Dropdown</span>
                      </button>
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="<?= base_url('guru/edit/') . $m->id_guru; ?>">Edit Data</a></li>
                        <li><a href="<?= base_url('guru/hapus/') . $m->id_guru; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data guru ini?')">Hapus Data</a></li>
                      </ul>
                    </div>
                  </td>
                </tr>
