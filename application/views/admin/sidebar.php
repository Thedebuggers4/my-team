    ...
    <section class="sidebar">
      ...
      <?php if ($this->session->userdata('status') == 'admin_login') { ?>
            ...
            <li <?= $this->uri->segment(1) == 'guru' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('guru'); ?>"><i class="fa fa-circle-o"></i>
                <span>Data Guru</span>
              </a>
            </li>
            <li <?= $this->uri->segment(1) == 'siswa' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('siswa'); ?>"><i class="fa fa-circle-o"></i>
                <span>Data Siswa</span>
              </a>
            </li>
            <li <?= $this->uri->segment(1) == 'soal_ujian' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('soal_ujian'); ?>"><i class="fa fa-circle-o"></i>
            ...
            <li <?= $this->uri->segment(1) == 'hasil_ujian' ? 'class="active"' : '' ?>>
              <a href="<?php echo base_url('hasil_ujian'); ?>"><i class="fa fa-circle-o"></i>
